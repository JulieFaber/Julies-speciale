...
plot(drm_Podo1_E_apparent,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ")
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Podo2_E_apparent,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_Podo3_E_apparent,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_Podo4_E_apparent,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Podo1_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ",ylim = c(0,10),lty=1)
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Podo2_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ",add = TRUE,col="red")
plot(drm_Podo3_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ",add = TRUE,col="blue")
plot(drm_Podo4_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ",add = TRUE,col="green")
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_E_apparent_avg,broken=TRUE,type = "all", xlab="", ylab="E_apparent ",ylim = c(0,10),lty=1,pch = 20)
title(main="Papaver rhoeas")
plot(drm_Podo4_E_apparent_avg,broken=TRUE,type = "all", xlab="", ylab="E_apparent ",add = TRUE,col="green",pch = 20)
...
plot(drm_Podo1_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent (mol m-2s-1) ",ylim =c(0,6),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_Podo4_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent (mol m-2s-1) ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "E_apparent_gly_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_gly_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_gly_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_gly_KV4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_gly_KV1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_gly_KV2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_gly_KV3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_gly_KV4_Effective dose w confint.csv")
