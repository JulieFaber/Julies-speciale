...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,5),lty=1)
title(main="Centaurea cyanus")
plot(drm_Harvest2_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",add = TRUE,col="red")
plot(drm_Harvest3_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",add = TRUE,col="blue")

grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,5),lty=1,pch = 20)
title(main="Centaurea cyanus")
...
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ",ylim =c(0,2),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Centaurea cyanus",cex = 2.5))
plot(drm_Harvest3_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "Total_shoot_l.s.b.f_phen_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Total_shoot_l.s.b.f_phen_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Total_shoot_l.s.b.f_phen_KB3_Parameter estimates.csv")
...
write.csv2(table1, "Total_shoot_l.s.b.f_phen_KB1_Effective dose w confint.csv")
write.csv2(table2, "Total_shoot_l.s.b.f_phen_KB2_Effective dose w confint.csv")
write.csv2(table3, "Total_shoot_l.s.b.f_phen_KB3_Effective dose w confint.csv")
