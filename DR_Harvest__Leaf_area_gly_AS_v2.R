...
plot(drm_Harvest1_leaf.area, broken= TRUE)
...
write.csv2(table1$coefficients, "leaf.area_gly_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "leaf.area_gly_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "leaf.area_gly_AS3_Parameter estimates.csv")
...
write.csv2(table1, "leaf.area_gly_AS1_Effective dose w confint.csv")
write.csv2(table2, "leaf.area_gly_AS2_Effective dose w confint.csv")
write.csv2(table3, "leaf.area_gly_AS3_Effective dose w confint.csv")
