...
drm_VA4_number <- drm(VA4_number~ Dose2, data=dat2,fct=LL.3())
...
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_number ")
title(main="Centaurea cyanus", sub="(day 6)")
plot(drm_VA2_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_number ")
title(main="Centaurea cyanus", sub="(day 13)")
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_number ")
title(main="Centaurea cyanus", sub="(day 20)")
plot(drm_VA4_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_number ")
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",ylim = c(0,5),lty=1,pch = 20)
title(main="Centaurea cyanus")
plot(drm_VA4_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",add = TRUE,col="blue",pch = 20)
...
write.csv2(table1$coefficients, "number_phen_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "number_phen_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "number_phen_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "number_phen_KB4_Parameter estimates.csv")
...
write.csv2(table1, "number_phen_KB1_Effective dose w confint.csv")
write.csv2(table2, "number_phen_KB2_Effective dose w confint.csv")
write.csv2(table3, "number_phen_KB3_Effective dose w confint.csv")
write.csv2(table4, "number_phen_KB4_Effective dose w confint.csv")
