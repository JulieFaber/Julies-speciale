...
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_bud ",ylim =c(0,5),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Sinapis arvensis",cex = 2.5))
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_bud ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "knop_gly_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "knop_gly_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "knop_gly_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "knop_gly_AS4_Parameter estimates.csv")
...
write.csv2(table1, "knop_gly_AS1_Effective dose w confint.csv")
write.csv2(table2, "knop_gly_AS2_Effective dose w confint.csv")
write.csv2(table3, "knop_gly_AS3_Effective dose w confint.csv")
write.csv2(table4, "knop_gly_AS4_Effective dose w confint.csv")
