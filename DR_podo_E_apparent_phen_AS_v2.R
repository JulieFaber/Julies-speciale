...
write.csv2(table1$coefficients, "E_apparent_phen_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_phen_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_phen_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_phen_AS4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_phen_AS1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_phen_AS2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_phen_AS3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_phen_AS4_Effective dose w confint.csv")
