...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="HA_LAR  ",ylim = c(0,300),lty=1)
...
write.csv2(table1$coefficients, "SLA_phen_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "SLA_phen_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "SLA_phen_BS3_Parameter estimates.csv")
...
write.csv2(table1, "SLA_phen_BS1_Effective dose w confint.csv")
write.csv2(table2, "SLA_phen_BS2_Effective dose w confint.csv")
write.csv2(table3, "SLA_phen_BS3_Effective dose w confint.csv")
