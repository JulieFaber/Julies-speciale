...
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_numbers ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_VA2_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_numbers ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_numbers ")
title(main="Papaver rhoeas", sub="(day 20)")
plot(drm_VA4_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_numbers ")
...
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_number ",ylim =c(0,5),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_number ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "number_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "number_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "number_gly_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "number_gly_KB4_Parameter estimates.csv")
...
write.csv2(table1, "number_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "number_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "number_gly_KB3_Effective dose w confint.csv")
write.csv2(table4, "number_gly_KB4_Effective dose w confint.csv")
