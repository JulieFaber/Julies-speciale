...
dat$Harvest1_leaf.area <- KB.numeric(dat$Harvest1_leaf.area)
dat$Harvest2_leaf.area <- KB.numeric(dat$Harvest2_leaf.area)
dat$Harvest3_leaf.area <- KB.numeric(dat$Harvest3_leaf.area)
...
drm_Harvest1_leaf.area <- drm(Harvest1_leaf.area~ Dose2, data=dat2,fct=LL.3())
drm_Harvest2_leaf.area <- drm(Harvest2_leaf.area~ Dose2, data=dat2,fct=LL.3())
drm_Harvest3_leaf.area <- drm(Harvest3_leaf.area~ Dose2, data=dat2,fct=LL.3())
...
plot(drm_Harvest1_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area ")
title(main="Centaurea cyanus", sub="(day 8)")
plot(drm_Harvest2_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area ")
title(main="Centaurea cyanus", sub="(day 15)")
plot(drm_Harvest3_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",ylim = c(0,200),lty=1)
title(main="Centaurea cyanus")
plot(drm_Harvest2_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",add = TRUE,col="red")
plot(drm_Harvest3_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",add = TRUE,col="blue")

grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",ylim = c(0,200),lty=1,pch = 20)
title(main="Centaurea cyanus")
plot(drm_Harvest3_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",add = TRUE,col="blue",pch = 20)
...
plot(drm_Harvest1_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",ylim =c(0,200),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Centaurea cyanus",cex = 2.5))
plot(drm_Harvest3_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "leaf.area_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "leaf.area_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "leaf.area_gly_KB3_Parameter estimates.csv")
...
write.csv2(table1, "leaf.area_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "leaf.area_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "leaf.area_gly_KB3_Effective dose w confint.csv")
