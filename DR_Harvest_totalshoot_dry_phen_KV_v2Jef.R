...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,1),lty=1)
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,1),lty=1,pch = 20)
title(main="Papaver rhoeas")
...
write.csv2(table1$coefficients, "Total_shoot_l.s.b.f_phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Total_shoot_l.s.b.f_phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Total_shoot_l.s.b.f_phen_KV3_Parameter estimates.csv")
...
write.csv2(table1, "Total_shoot_l.s.b.f_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "Total_shoot_l.s.b.f_phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "Total_shoot_l.s.b.f_phen_KV3_Effective dose w confint.csv")
