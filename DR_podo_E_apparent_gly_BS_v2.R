...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_E_apparent_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="E_apparent ",ylim = c(0,10),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "E_apparent_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_gly_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_gly_BS4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_gly_BS3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_gly_BS4_Effective dose w confint.csv")
