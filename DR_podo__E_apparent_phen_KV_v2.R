...
write.csv2(table1$coefficients, "E_apparent_Phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_Phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_Phen_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_Phen_KV4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_Phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_Phen_KV3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_Phen_Kv4_Effective dose w confint.csv")
