...
plot(drm_Podo4_E_apparent_avg,broken=TRUE,type = "all", ylab="E_apparent ",add = TRUE,col="green",pch = 20)
...
write.csv2(table1$coefficients, "E_apparent_phen_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_phen_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_phen_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_phen_BS4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_phen_BS1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_phen_BS2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_phen_BS3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_phen_BS4_Effective dose w confint.csv")
