...
plot(drm_VA4_number, broken= TRUE)
...
write.csv2(table1$coefficients, "number_gly_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "number_gly_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "number_gly_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "number_gly_AS4_Parameter estimates.csv")
...
write.csv2(table1, "number_gly_AS1_Effective dose w confint.csv")
write.csv2(table2, "number_gly_AS2_Effective dose w confint.csv")
write.csv2(table3, "number_gly_AS3_Effective dose w confint.csv")
write.csv2(table4, "number_gly_AS4_Effective dose w confint.csv")
