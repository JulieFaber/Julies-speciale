...
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="SLA  ",ylim = c(0,2),lty=1)
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="SLA  ",ylim = c(0,2),lty=1,pch = 20)
title(main="Geranium molle")
...
write.csv2(table1$coefficients, "SLA_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "SLA_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "SLA_gly_BS3_Parameter estimates.csv")
...
write.csv2(table1, "SLA_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "SLA_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "SLA_gly_BS3_Effective dose w confint.csv")
