...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VPDleaf ",ylim = c(0,2),lty=1)
title(main="Papaver rhoeas", sub="(day 2)")
...
plot(drm_Podo4_VPDleaf_avg,broken=TRUE,type = "all", xlab="", ylab="VPDleaf ",add = TRUE,col="green",pch = 20)
...
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VPDleaf (kPa) ",ylim =c(0,2),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
...
write.csv2(table1$coefficients, "VPDleaf_gly_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_gly_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_gly_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_gly_KV4_Parameter estimates.csv")
...
write.csv2(table1, "VPDleaf_gly_KV1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_gly_KV2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_gly_KV3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_gly_KV4_Effective dose w confint.csv")
