...
write.csv2(table1$coefficients, "knop_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "knop_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "knop_gly_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "knop_gly_BS4_Parameter estimates.csv")
...
write.csv2(table1, "knop_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "knop_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "knop_gly_BS3_Effective dose w confint.csv")
write.csv2(table4, "knop_gly_BS4_Effective dose w confint.csv")
