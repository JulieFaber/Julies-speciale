...
write.csv2(table1$coefficients, "Total_shoot_l.s.b.f_gly_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Total_shoot_l.s.b.f_gly_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Total_shoot_l.s.b.f_gly_AS3_Parameter estimates.csv")
...
write.csv2(table1, "Total_shoot_l.s.b.f_gly_AS1_Effective dose w confint.csv")
write.csv2(table2, "Total_shoot_l.s.b.f_gly_AS2_Effective dose w confint.csv")
write.csv2(table3, "Total_shoot_l.s.b.f_gly_AS3_Effective dose w confint.csv")
