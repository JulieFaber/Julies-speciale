...
plot(drm_Podo1_VPDleaf,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ")
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Podo2_VPDleaf,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_Podo3_VPDleaf,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_Podo4_VPDleaf,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ",ylim = c(0,2),lty=1)
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Podo2_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ",add = TRUE,col="red")
plot(drm_Podo3_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ",add = TRUE,col="blue")
plot(drm_Podo4_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf ",add = TRUE,col="green")
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf (kPa) ",ylim = c(0,2),lty=1,pch = 20)
title(main="Papaver rhoeas")
plot(drm_Podo4_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf (kPa) ",add = TRUE,col="green",pch = 20)
...
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf (kPa)",ylim =c(0,2),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_Podo4_VPDleaf_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VPDleaf (kPa) ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "VPDleaf_Phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_Phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_Phen_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_Phen_KV4_Parameter estimates.csv")
...
write.csv2(table1, "VPDleaf_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_Phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_Phen_KV3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_Phen_Kv4_Effective dose w confint.csv")
