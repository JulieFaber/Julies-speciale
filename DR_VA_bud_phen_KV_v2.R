...
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_bud ",ylim =c(0,5),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_VA4_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_bud ",add = TRUE,col="blue",pch = 2,lwd=3)
legend("topleft",col = c("black","blue"),legend = c("day 20","day 44"),lty = c(1,1),pch = c(20,2))
...
write.csv2(table1$coefficients, "knop_phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "knop_phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "knop_phen_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "knop_phen_KV4_Parameter estimates.csv")
...
write.csv2(table1, "knop_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "knop_phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "knop_phen_KV3_Effective dose w confint.csv")
write.csv2(table4, "knop_phen_KV4_Effective dose w confint.csv")
