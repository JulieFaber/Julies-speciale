...
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_knop ")
title(main="Centaurea cyanus", sub="(day 6)")
plot(drm_VA2_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_knop ")
title(main="Centaurea cyanus", sub="(day 13)")
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_knop ")
title(main="Centaurea cyanus", sub="(day 20)")
plot(drm_VA4_knop,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA4_knop ")
...
write.csv2(table1$coefficients, "knop_phen_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "knop_phen_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "knop_phen_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "knop_phen_KB4_Parameter estimates.csv")
...
write.csv2(table1, "knop_phen_KB1_Effective dose w confint.csv")
write.csv2(table2, "knop_phen_KB2_Effective dose w confint.csv")
write.csv2(table3, "knop_phen_KB3_Effective dose w confint.csv")
write.csv2(table4, "knop_phen_KB4_Effective dose w confint.csv")
