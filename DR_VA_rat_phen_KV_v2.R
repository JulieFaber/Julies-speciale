...
par(mfrow=c(2,2))
plot(dat2$Dose,dat2$VA1_number, ylim = c(0,10),col="black")
plot(dat2$Dose,dat2$VA2_number, ylim = c(0,10),col="blue")
plot(dat2$Dose,dat2$VA3_number, ylim = c(0,10),col="red")
plot(dat2$Dose,dat2$VA4_number, ylim = c(0,10),col="green")
par(mfrow=c(1,1))
...
drm_VA2_number <- drm(VA2_number~ Dose2, data=dat2,fct=LL.3())
...
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_VA2_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ")
title(main="Papaver rhoeas", sub="(day 20)")
plot(drm_VA4_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",ylim = c(0,10),lty=1)
title(main="Papaver rhoeas")
plot(drm_VA2_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",add = TRUE,col="red")
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",add = TRUE,col="blue")
plot(drm_VA4_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",add = TRUE,col="green")
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_VA1_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",ylim = c(0,10),lty=1,pch = 20)
title(main="Papaver rhoeas")
plot(drm_VA3_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number  ",add = TRUE,col="blue",pch = 20)
...
plot(drm_VA_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ",ylim =c(0,5),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_VA2_number,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="VA_number ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "number_phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "number_phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "number_phen_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "number_phen_KV4_Parameter estimates.csv")
...
write.csv2(table1, "number_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "number_phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "number_phen_KV3_Effective dose w confint.csv")
write.csv2(table4, "number_phen_KV4_Effective dose w confint.csv")
