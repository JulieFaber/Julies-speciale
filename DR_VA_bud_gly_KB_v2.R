...
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop ")
title(main="Centaurea cyanus", sub="(day 6)")
plot(drm_VA2_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop ")
title(main="Centaurea cyanus", sub="(day 13)")
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop ")
...
plot(drm_VA3knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_bud ",ylim =c(0,10),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Centaurea cyanus",cex = 2.5))
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate(g a.i.ha^-1)", ylab="VA_bud ",add = TRUE,col="blue",pch = 20,lwd=3)
plot(drm_VA2_knop,broken=TRUE,type = "all", xlab="Glyphosate(g a.i.ha^-1)", ylab="VA_bud ",add = TRUE,col="black",pch = 2,lwd=3)
