...
plot(drm_Dua1_Flav,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavonoids ")
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Dua2_Flav,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavonoids ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_Dua3_Flav,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavonoids ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_Dua4_Flav,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavonoids ")
...
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.0,1),lty=1)
title(main="Papaver rhoeas", sub="(day 2)")
plot(drm_Dua2_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="red")
plot(drm_Dua3_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="blue")
plot(drm_Dua4_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="green")
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.2,0.8),lty=1,pch = 20)
title(main="Papaver rhoeas")
plot(drm_Dua4_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="green",pch = 20)
...
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.1,1),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_Dua4_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "Flav_Phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_Phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_Phen_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_Phen_KV4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_Phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "Flav_Phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "Flav_Phen_KV3_Effective dose w confint.csv")
write.csv2(table4, "Flav_Phen_KV4_Effective dose w confint.csv")
