...
write.csv2(table1$coefficients, "leaf.area_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "leaf.area_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "leaf.area_gly_BS3_Parameter estimates.csv")
...
write.csv2(table1, "leaf.area_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "leaf.area_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "leaf.area_gly_BS3_Effective dose w confint.csv")
