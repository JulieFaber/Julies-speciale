...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,0.8),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "Flav_Phen_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_Phen_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_Phen_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_Phen_AS4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_Phen_AS1_Effective dose w confint.csv")
write.csv2(table2, "Flav_Phen_AS2_Effective dose w confint.csv")
write.csv2(table3, "Flav_Phen_AS3_Effective dose w confint.csv")
write.csv2(table4, "Flav_Phen_AS4_Effective dose w confint.csv")
