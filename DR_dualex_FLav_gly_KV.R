...
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,1600),lty=1)
title(main="Papaver rhoeas", sub="(day 2)")
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,600),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "Flav_gly_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_gly_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_gly_KV3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_gly_KV4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_gly_KV1_Effective dose w confint.csv")
write.csv2(table2, "Flav_gly_KV2_Effective dose w confint.csv")
write.csv2(table3, "Flav_gly_KV3_Effective dose w confint.csv")
write.csv2(table4, "Flav_gly_KV4_Effective dose w confint.csv")
