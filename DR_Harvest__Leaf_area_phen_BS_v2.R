...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_leaf.area,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="leaf.area  ",ylim = c(0,300),lty=1)
...
write.csv2(table1$coefficients, "leaf.area_phen_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "leaf.area_phen_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "leaf.area_phen_BS3_Parameter estimates.csv")
...
write.csv2(table1, "leaf.area_phen_BS1_Effective dose w confint.csv")
write.csv2(table2, "leaf.area_phen_BS2_Effective dose w confint.csv")
write.csv2(table3, "leaf.area_phen_BS3_Effective dose w confint.csv")
