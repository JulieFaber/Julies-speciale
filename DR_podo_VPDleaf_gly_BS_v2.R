...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VPDleaf ",ylim = c(0,3),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "VPDleaf_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_gly_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_gly_BS4_Parameter estimates.csv")
...
write.csv2(table1, "VPDleaf_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_gly_BS3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_gly_BS4_Effective dose w confint.csv")
