...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,200),lty=1)
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,30),lty=1,pch = 20)
title(main="Geranium molle")
...
write.csv2(table1$coefficients, "Total_shoot_l.s.b.f_gly_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Total_shoot_l.s.b.f_gly_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Total_shoot_l.s.b.f_gly_BS3_Parameter estimates.csv")
...
write.csv2(table1, "Total_shoot_l.s.b.f_gly_BS1_Effective dose w confint.csv")
write.csv2(table2, "Total_shoot_l.s.b.f_gly_BS2_Effective dose w confint.csv")
write.csv2(table3, "Total_shoot_l.s.b.f_gly_BS3_Effective dose w confint.csv")
