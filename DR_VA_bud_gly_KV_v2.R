...
par(mfrow=c(2,2))
plot(dat2$Dose,dat2$VA1_knop, ylim = c(0,5),col="black")
plot(dat2$Dose,dat2$VA2_knop, ylim = c(0,5),col="blue")
plot(dat2$Dose,dat2$VA3_knop, ylim = c(0,5),col="red")
plot(dat2$Dose,dat2$VA4_knop, ylim = c(0,5),col="green")
par(mfrow=c(1,1))
...
drm_VA3_knop <- drm(VA3_knop~ Dose2, data=dat2,fct=LL.4())
...
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knops ")
title(main="Papaver rhoeas", sub="(day 6)")
plot(drm_VA2_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knops ")
title(main="Papaver rhoeas", sub="(day 13)")
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knops ")
title(main="Papaver rhoeas", sub="(day 20)")
plot(drm_VA4_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knops ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",ylim = c(0,10),lty=1)
title(main="Papaver rhoeas")
plot(drm_VA2_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",add = TRUE,col="red")
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",add = TRUE,col="blue")
plot(drm_VA4_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",add = TRUE,col="green")
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_VA1_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",ylim = c(0,10),lty=1,pch = 20)
title(main="Papaver rhoeas")
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_knop  ",add = TRUE,col="blue",pch = 20)
...
plot(drm_VA3_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_bud ",ylim =c(0,5),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Papaver rhoeas",cex = 2.5))
plot(drm_VA4_knop,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VA_bud ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "knop_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "knop_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "knop_gly_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "knop_gly_KB4_Parameter estimates.csv")
...
write.csv2(table1, "knop_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "knop_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "knop_gly_KB3_Effective dose w confint.csv")
write.csv2(table4, "knop_gly_KB4_Effective dose w confint.csv")
