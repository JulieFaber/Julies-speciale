...
write.csv2(table1$coefficients, "VPDleaf_phen_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_phen_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_phen_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_phen_AS4_Parameter estimates.csv")
...
write.csv2(table1, "VPDleaf_phen_AS1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_phen_AS2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_phen_AS3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_phen_AS4_Effective dose w confint.csv")
