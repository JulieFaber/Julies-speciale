...
dat$Harvest1_Total_shoot_l.s.b.f <- KB.numeric(dat$Harvest1_Total_shoot_l.s.b.f)
dat$Harvest2_Total_shoot_l.s.b.f <- KB.numeric(dat$Harvest2_Total_shoot_l.s.b.f)
dat$Harvest3_Total_shoot_l.s.b.f <- KB.numeric(dat$Harvest3_Total_shoot_l.s.b.f)
...
par(mfrow=c(2,2))
plot(dat2$Dose,dat2$Harvest1_Total_shoot_l.s.b.f, ylim = c(0,10),col="black")
plot(dat2$Dose,dat2$Harvest2_Total_shoot_l.s.b.f, ylim = c(0,10),col="blue")
plot(dat2$Dose,dat2$Harvest3_Total_shoot_l.s.b.f, ylim = c(0,10),col="red")
...
drm_Harvest1_Total_shoot_l.s.b.f <- drm(Harvest1_Total_shoot_l.s.b.f~ Dose2, data=dat2,fct=LL.3())
drm_Harvest2_Total_shoot_l.s.b.f <- drm(Harvest2_Total_shoot_l.s.b.f~ Dose2, data=dat2,fct=LL.3))
drm_Harvest3_Total_shoot_l.s.b.f <- drm(Harvest3_Total_shoot_l.s.b.f~ Dose2, data=dat2,fct=LL.3())
...
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ")
title(main="Centaurea cyanus", sub="(day 8)")
plot(drm_Harvest2_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ")
title(main="Centaurea cyanus", sub="(day 15)")
plot(drm_Harvest3_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,5),lty=1)
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",ylim = c(0,5),lty=1,pch = 20)
title(main="Centaurea cyanus")
plot(drm_Harvest3_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f  ",add = TRUE,col="blue",pch = 20)
...
plot(drm_Harvest1_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ",ylim =c(0,2),lty=1, lwd=3,pch = 20,cex.axis = 1.5, cex.lab=1.5)
title(main=list("Centaurea cyanus",cex = 2.5))
plot(drm_Harvest3_Total_shoot_l.s.b.f,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Total_shoot_l.s.b.f ",add = TRUE,col="blue",pch = 2,lwd=3)
...
write.csv2(table1$coefficients, "Total_shoot_l.s.b.f_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Total_shoot_l.s.b.f_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Total_shoot_l.s.b.f_gly_KB3_Parameter estimates.csv")
...
write.csv2(table1, "Total_shoot_l.s.b.f_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "Total_shoot_l.s.b.f_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "Total_shoot_l.s.b.f_gly_KB3_Effective dose w confint.csv")
