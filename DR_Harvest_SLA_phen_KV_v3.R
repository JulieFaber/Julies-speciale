...
write.csv2(table1$coefficients, "SLA_phen_KV1_Parameter estimates.csv")
write.csv2(table2$coefficients, "SLA_phen_KV2_Parameter estimates.csv")
write.csv2(table3$coefficients, "SLA_phen_KV3_Parameter estimates.csv")
...
write.csv2(table1, "SLA_phen_KV1_Effective dose w confint.csv")
write.csv2(table2, "SLA_phen_KV2_Effective dose w confint.csv")
write.csv2(table3, "SLA_phen_KV3_Effective dose w confint.csv")
