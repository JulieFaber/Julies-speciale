...
plot(drm_Harvest1_SLA, broken= TRUE)

par(mfrow=c(2,2))
#plotting the model with all data
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR ")
title(main="Sinapis arvensis", sub="(day 8)")
plot(drm_Harvest2_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR ")
title(main="Sinapis arvensis", sub="(day 15)")
plot(drm_Harvest3_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR ")
...
par(mfrow=c(1,1))
#plotting the model with all data
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR  ",ylim = c(0,200),lty=1)
title(main="Sinapis arvensis")
plot(drm_Harvest2_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR  ",add = TRUE,col="red")
plot(drm_Harvest3_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR  ",add = TRUE,col="blue")

grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Harvest1_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR  ",ylim = c(0,200),lty=1,pch = 20)
title(main="Sinapis arvensis")
plot(drm_Harvest3_SLA,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="HA_LAR  ",add = TRUE,col="blue",pch = 20)
...
write.csv2(table1$coefficients, "SLA_phen_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "SLA_phen_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "SLA_phen_AS3_Parameter estimates.csv")
...
write.csv2(table1, "SLA_phen_AS1_Effective dose w confint.csv")
write.csv2(table2, "SLA_phen_AS2_Effective dose w confint.csv")
write.csv2(table3, "SLA_phen_AS3_Effective dose w confint.csv")
