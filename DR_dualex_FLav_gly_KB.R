...
plot(drm_Dua4_Flav,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="Flavonoiods ")
...
write.csv2(table1$coefficients, "Flav_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_gly_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_gly_KB4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "Flav_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "Flav_gly_KB3_Effective dose w confint.csv")
write.csv2(table4, "Flav_gly_KB4_Effective dose w confint.csv")
