...
write.csv2(table1$coefficients, "E_apparent_gly_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "E_apparent_gly_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "E_apparent_gly_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "E_apparent_gly_KB4_Parameter estimates.csv")
...
write.csv2(table1, "E_apparent_gly_KB1_Effective dose w confint.csv")
write.csv2(table2, "E_apparent_gly_KB2_Effective dose w confint.csv")
write.csv2(table3, "E_apparent_gly_KB3_Effective dose w confint.csv")
write.csv2(table4, "E_apparent_gly_KB4_Effective dose w confint.csv")
