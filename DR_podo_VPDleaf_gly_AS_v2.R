...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="Glyphosate (g a.i.ha^-1)", ylab="VPDleaf ",ylim = c(0,2),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "VPDleaf_gly_AS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_gly_AS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_gly_AS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_gly_AS4_Parameter estimates.csv")
...
drm_Podo1_VPDleaf_avg$df.residual
...
write.csv2(table1, "VPDleaf_gly_AS1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_gly_AS2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_gly_AS3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_gly_AS4_Effective dose w confint.csv")
