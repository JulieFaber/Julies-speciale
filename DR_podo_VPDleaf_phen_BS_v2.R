...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Podo1_VPDleaf_avg,broken=TRUE,type = "all", xlab="", ylab="VPDleaf ",ylim = c(0,2),lty=1,pch = 20)
title(main="Geranium molle")
plot(drm_Podo4_VPDleaf_avg,broken=TRUE,type = "all", ylab="VPDleaf ",add = TRUE,col="green",pch = 20)
...
write.csv2(table1$coefficients, "VPDleaf_phen_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "VPDleaf_phen_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "VPDleaf_phen_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "VPDleaf_phen_BS4_Parameter estimates.csv")
...
write.csv2(table1, "VPDleaf_phen_BS1_Effective dose w confint.csv")
write.csv2(table2, "VPDleaf_phen_BS2_Effective dose w confint.csv")
write.csv2(table3, "VPDleaf_phen_BS3_Effective dose w confint.csv")
write.csv2(table4, "VPDleaf_phen_BS4_Effective dose w confint.csv")
