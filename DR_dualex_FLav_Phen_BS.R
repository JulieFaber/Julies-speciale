...
drm_Dua4_Flav_avg <- drm(Dua4_Flav_avg~ Dose2, data=dat3,fct=LL.3())
...
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,200),lty=1)
title(main="Geranium molle", sub="(day 2)")
...
#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.1,1),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "Flav_Phen_BS1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_Phen_BS2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_Phen_BS3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_Phen_BS4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_Phen_BS1_Effective dose w confint.csv")
write.csv2(table2, "Flav_Phen_BS2_Effective dose w confint.csv")
write.csv2(table3, "Flav_Phen_BS3_Effective dose w confint.csv")
write.csv2(table4, "Flav_Phen_BS4_Effective dose w confint.csv")
