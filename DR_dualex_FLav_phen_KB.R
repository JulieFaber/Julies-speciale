...
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,1),lty=1)
title(main="Centaurea cyanus", sub="(day 2)")
...
plot(drm_Dua4_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",add = TRUE,col="green") #den grønne er meget høj
grid()

#Fitting a dose-response model to data
par(mfrow=c(1,1))
plot(drm_Dua1_Flav_avg,broken=TRUE,type = "all", xlab="Phenmedipharm (g a.i.ha^-1)", ylab="Flavocyanins ",ylim = c(0.4,1000),lty=1,pch = 20)
...
write.csv2(table1$coefficients, "Flav_Phen_KB1_Parameter estimates.csv")
write.csv2(table2$coefficients, "Flav_Phen_KB2_Parameter estimates.csv")
write.csv2(table3$coefficients, "Flav_Phen_KB3_Parameter estimates.csv")
write.csv2(table4$coefficients, "Flav_Phen_KB4_Parameter estimates.csv")
...
write.csv2(table1, "Flav_Phen_KB1_Effective dose w confint.csv")
write.csv2(table2, "Flav_Phen_KB2_Effective dose w confint.csv")
write.csv2(table3, "Flav_Phen_KB3_Effective dose w confint.csv")
write.csv2(table4, "Flav_Phen_KB4_Effective dose w confint.csv")
